...
function facebookImport() {
  var accessToken = 'EAAbsTPWTuVIBAMYTrOQKjWandJK1iJoHj3Fw8GVoy1oqbg6ZCZBUz6niBGLJZAarwLeZAfMYkiZBUI0rRrkEKZAYknoeIiFczTLdyLjbkzPSI42OXQhi96Yt8dJSQ5s5HNquZAR2f5E8NmvzJZAh1hGJvwvbpbVG9FIZD';
  var date = 'yesterday';
  ...
  function echoAuth() {
    ...
    if (token === null) {
      ...
      var payload = {
        'email' : 'kenans@groundwire.net',
        'password' : '39Wobblyapes'
      };
